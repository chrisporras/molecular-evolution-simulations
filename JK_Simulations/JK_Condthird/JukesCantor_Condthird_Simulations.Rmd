...
setcond <- 3 #Choose second most prevalent AA
...
distmax <- 10
distcount<- 1:distmax
distname3.mat <- matrix(data = 0, nrow=distmax,ncol = 1)
for(z in 1:distmax){
...
#Write to csv
distname3 <-paste("JK_SSD_Distribution",csvmarker,distcount[z],".csv",sep="")
distname3.mat [z,] <- distname3
write.csv(ssd.distri, file = distname3)
