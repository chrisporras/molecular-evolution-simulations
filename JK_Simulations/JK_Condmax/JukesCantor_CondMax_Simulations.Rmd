...
setcond <- 1 #Choose most prevalent AA
csvmarker<- "condmax"
...
```{r}
### Testing "JUKES-CANTOR"" with "fake" amino acid sequence & conditioned on most prevalent AA
...
distmax <- 10
distcount<- 1:distmax
distname1.mat <- matrix(data = 0, nrow=distmax,ncol = 1)
for(z in 1:distmax){
...
#Write to csv
distname1 <-paste("JK_SSD_Distribution",csvmarker,distcount[z],".csv",sep="")
distname1.mat [z,] <- distname1
write.csv(ssd.distri, file = distname1)
